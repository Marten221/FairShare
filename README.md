...
- **Cloud Sync**: Enable secure, real-time synchronization across devices using Firebase Authentication
...
- **Secure Authentication**: Secure login & cloud sync with Firebase
...
- **Room Database**: 2.8.1 (for local data persistence)
- **Coroutines**: 1.10.2 (for asynchronous operations)
- **Navigation Compose**: 2.9.5
- **Material 3**: 1.3.2
- **Firebase Authentication**: (configured via Firebase)
